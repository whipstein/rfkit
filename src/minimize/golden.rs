...
use crate::{error::MinimizerError, minimize::ObjFn, num::RealScalar};
use std::fmt;
    ...
    T: RealScalar,
{
    ...
    pub fn golden_section_search(
        ...
        let mut x2 = x1 + (1.0 - Golden::<T>::GOLDEN_RATIO).into() * (x4 - x1);
        let mut x3 = x1 + Golden::<T>::GOLDEN_RATIO.into() * (x4 - x1);
        ...
        while (x4 - x1).abs() > tol && self.iters < max_iter {
            ...
            if f2 < f3 {
                ...
                x3 = x2;
                f3 = f2;
                x2 = x1 + (1.0 - Golden::<T>::GOLDEN_RATIO) * (x4 - x1);
                ...
                x2 = x3;
                f2 = f3;
                x3 = x1 + Golden::<T>::GOLDEN_RATIO * (x4 - x1);
...
mod minimize_golden_tests {
    ...
    mod mathematical_function_tests {
        ...
        fn test_exponential_and_logarithmic_functions() {
            ...
            let exp_func = |x: &TwoFloat| E.powf((x - 1.0).to_f64()).into();
