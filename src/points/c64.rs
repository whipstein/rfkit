...
impl Points<Complex64> {
    pub fn new(array: Array3<Complex64>) -> Self {
        Points(array)
    }
}

impl Pts<Complex64, f64> for Points<Complex64> {
    ...
    fn inv(&self) -> Points<Complex64> {
        self.try_inv().unwrap()
    }

    fn try_inv(&self) -> Result<Points<Complex64>, InversionError> {
...
// Indexing
impl Index<(usize, usize, usize)> for Points<Complex64> {
...
impl Index<[usize; 3]> for Points<Complex64> {
    type Output = Complex64;
...
impl IndexMut<(usize, usize, usize)> for Points<Complex64> {
    fn index_mut(&mut self, index: (usize, usize, usize)) -> &mut Self::Output {
        &mut self.0[index]
    }
}

impl IndexMut<[usize; 3]> for Points<Complex64> {
...
impl Add<&Points<Complex64>> for Points<Complex64> {
    type Output = Self;
...
impl Add<Points<Complex64>> for &Points<Complex64> {
    type Output = Points<Complex64>;

    fn add(self, other: Points<Complex64>) -> Points<Complex64> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for addition: {:?} vs {:?}",
                self.shape(),
...
// Scalar addition
impl Add<Complex64> for Points<Complex64> {
    type Output = Self;
...
impl Add<Complex64> for &Points<Complex64> {
    ...
    fn add(self, scalar: Complex64) -> Points<Complex64> {
        Points(self.0.map(|x| x + &scalar))
    }
}
...
impl Add<f64> for Points<Complex64> {
    type Output = Self;
...
impl Add<f64> for &Points<Complex64> {
    ...
    fn add(self, scalar: f64) -> Points<Complex64> {
        Points(self.0.map(|x| x + &scalar))
    }
}
...
impl Sub<&Points<Complex64>> for Points<Complex64> {
    type Output = Self;
...
impl Sub<Points<Complex64>> for &Points<Complex64> {
    ...
    fn sub(self, other: Points<Complex64>) -> Points<Complex64> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for subtraction: {:?} vs {:?}",
                self.shape(),
...
// Scalar subtraction
impl Sub<Complex64> for Points<Complex64> {
    type Output = Self;
...
impl Sub<Complex64> for &Points<Complex64> {
    ...
    fn sub(self, scalar: Complex64) -> Points<Complex64> {
        Points(self.0.map(|x| x - &scalar))
    }
}
...
impl Sub<f64> for Points<Complex64> {
    type Output = Self;
...
impl Sub<f64> for &Points<Complex64> {
    ...
    fn sub(self, scalar: f64) -> Points<Complex64> {
        Points(self.0.map(|x| x - &scalar))
    }
}
...
impl Mul<&Points<Complex64>> for Points<Complex64> {
    type Output = Self;
...
impl Mul<Points<Complex64>> for &Points<Complex64> {
    ...
    fn mul(self, other: Points<Complex64>) -> Points<Complex64> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise multiplication: {:?} vs {:?}",
                self.shape(),
...
impl Mul<Complex64> for Points<Complex64> {
    type Output = Self;
...
impl Mul<Complex64> for &Points<Complex64> {
    ...
    fn mul(self, scalar: Complex64) -> Points<Complex64> {
        Points(self.0.map(|x| x * &scalar))
    }
}
...
impl Mul<f64> for Points<Complex64> {
    type Output = Self;
...
impl Mul<f64> for &Points<Complex64> {
    ...
    fn mul(self, scalar: f64) -> Points<Complex64> {
        Points(self.0.map(|x| x * &scalar))
    }
}
...
impl Div<&Points<Complex64>> for Points<Complex64> {
    type Output = Self;
...
impl Div<Points<Complex64>> for &Points<Complex64> {
    ...
    fn div(self, other: Points<Complex64>) -> Points<Complex64> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise division: {:?} vs {:?}",
                self.shape(),
...
// Scalar division
impl Div<Complex64> for Points<Complex64> {
    type Output = Self;
...
impl Div<Complex64> for &Points<Complex64> {
    ...
    fn div(self, scalar: Complex64) -> Points<Complex64> {
        Points(self.0.map(|x| x / &scalar))
    }
}
...
impl Div<f64> for Points<Complex64> {
    type Output = Self;
...
impl Div<f64> for &Points<Complex64> {
    ...
    fn div(self, scalar: f64) -> Points<Complex64> {
        Points(self.0.map(|x| x / &scalar))
    }
}
...
impl Neg for &Points<Complex64> {
    ...
    fn neg(self) -> Points<Complex64> {
        Points(-&self.0)
    }
}

// Assignment operators
impl AddAssign for Points<Complex64> {
...
impl AddAssign<&Points<Complex64>> for Points<Complex64> {
    fn add_assign(&mut self, other: &Points<Complex64>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for addition: {:?} vs {:?}",
                self.shape(),
...
impl SubAssign for Points<Complex64> {
...
impl SubAssign<&Points<Complex64>> for Points<Complex64> {
    fn sub_assign(&mut self, other: &Points<Complex64>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for subtraction: {:?} vs {:?}",
                self.shape(),
...
impl MulAssign for Points<Complex64> {
...
impl MulAssign<&Points<Complex64>> for Points<Complex64> {
    fn mul_assign(&mut self, other: &Points<Complex64>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise multiplication: {:?} vs {:?}",
                self.shape(),
...
impl DivAssign for Points<Complex64> {
...
impl DivAssign<&Points<Complex64>> for Points<Complex64> {
    fn div_assign(&mut self, other: &Points<Complex64>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise division: {:?} vs {:?}",
                self.shape(),
...
impl AddAssign<Complex64> for Points<Complex64> {
    fn add_assign(&mut self, scalar: Complex64) {
        self.0.map_inplace(|x| *x = &*x + &scalar);
    }
}

impl AddAssign<f64> for Points<Complex64> {
...
impl SubAssign<Complex64> for Points<Complex64> {
    fn sub_assign(&mut self, scalar: Complex64) {
        self.0.map_inplace(|x| *x = &*x - &scalar);
    }
}

impl SubAssign<f64> for Points<Complex64> {
...
impl MulAssign<Complex64> for Points<Complex64> {
    fn mul_assign(&mut self, scalar: Complex64) {
        self.0.map_inplace(|x| *x = &*x * &scalar);
    }
}

impl MulAssign<f64> for Points<Complex64> {
...
impl DivAssign<Complex64> for Points<Complex64> {
    fn div_assign(&mut self, scalar: Complex64) {
        self.0.map_inplace(|x| *x = &*x / &scalar);
    }
}

impl DivAssign<f64> for Points<Complex64> {
...
// Traits
impl Clone for Points<Complex64> {
    fn clone(&self) -> Self {
        Points(self.0.clone())
    }
}

impl Default for Points<Complex64> {
    fn default() -> Self {
        Points::zeros((0, 0, 0))
    }
}

impl PartialEq for Points<Complex64> {
...
impl Zero for Points<Complex64> {
    fn zero() -> Self {
        Points::zeros((0, 0, 0))
    }
...
impl fmt::Display for Points<Complex64> {
...
impl fmt::Debug for Points<Complex64> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "Points({}x{}x{}) {}",
...
// Conversion traits
impl From<Array3<Complex64>> for Points<Complex64> {
    fn from(array: Array3<Complex64>) -> Self {
        Points(array)
    }
}

impl From<ArrayView3<'_, Complex64>> for Points<Complex64> {
    fn from(array: ArrayView3<Complex64>) -> Self {
        Points(array.to_owned())
    }
}

impl From<Points<Complex64>> for Array3<Complex64> {
    fn from(matrix: Points<Complex64>) -> Self {
        matrix.0
    }
}

impl From<Vec<Vec<Vec<Complex64>>>> for Points<Complex64> {
    fn from(data: Vec<Vec<Vec<Complex64>>>) -> Self {
        Points::from_vec(data).expect("Invalid matrix data")
    }
}

impl From<Vec<Vec<Vec<f64>>>> for Points<Complex64> {
    fn from(data: Vec<Vec<Vec<f64>>>) -> Self {
        Points::from_vec_f64(data).expect("Invalid matrix data")
    }
}

impl From<Vec<Vec<Vec<(f64, f64)>>>> for Points<Complex64> {
...
mod points_c64_tests {
    ...
    fn test_from_vec() {
        ...
        let matrix = Points::<Complex64>::from_vec(data).unwrap();
    ...
    fn test_from_vec_f64() {
        ...
        let matrix = Points::<Complex64>::from_vec_f64(data).unwrap();
    ...
    fn test_from_vec_float() {
        ...
        let matrix = Points::<Complex64>::from_vec_float(data).unwrap();
    ...
    fn test_from_vec_c64() {
        ...
        let matrix = Points::<Complex64>::from_vec_c64(data).unwrap();
    ...
    fn test_from_vec_complex() {
        ...
        let matrix = Points::<Complex64>::from_vec_complex(data).unwrap();
    ...
    #[test]
    fn test_arithmetic() {
        let a = Points::<Complex64>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let b = Points::<Complex64>::from_vec_f64(vec![
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
    ...
    fn test_scalar_operations() {
        let matrix = Points::<Complex64>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();
    ...
    fn test_assignment_operators() {
        let mut matrix = Points::<Complex64>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let other = Points::<Complex64>::from_vec_f64(vec![
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
            vec![vec![9.0, 10.0], vec![11.0, 12.0]],
        ])
        .unwrap();
    ...
    #[test]
    fn test_equality() {
        let matrix1 = Points::<Complex64>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let matrix2 = Points::<Complex64>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let matrix3 = Points::<Complex64>::from_vec_f64(vec![
    ...
    fn test_error_cases() {
        ...
        let matrix1 = Points::<Complex64>::zeros((2, 4, 5));
        let matrix2 = Points::<Complex64>::zeros((3, 2, 1));
    ...
    fn test_conversions() {
        ...
        let matrix: Points<Complex64> = data.into();
        assert_eq!(matrix[(0, 0, 0)].re, 1.0);
        assert_eq!(matrix[(1, 1, 1)].re, 8.0);
