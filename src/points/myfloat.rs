...
impl Pts<MyFloat, MyFloat> for Points<MyFloat> {
    ...
    fn from_shape_vec(shape: (usize, usize, usize), v: Vec<MyFloat>) -> Result<Self, &'static str> {
    ...
    fn inv(&self) -> Points<MyFloat> {
        self.try_inv().unwrap()
    }

    fn try_inv(&self) -> Result<Points<MyFloat>, InversionError> {
...
// Indexing
impl Index<(usize, usize, usize)> for Points<MyFloat> {
    type Output = MyFloat;
...
impl Index<[usize; 3]> for Points<MyFloat> {
    type Output = MyFloat;
...
impl IndexMut<(usize, usize, usize)> for Points<MyFloat> {
    fn index_mut(&mut self, index: (usize, usize, usize)) -> &mut Self::Output {
        &mut self.0[index]
    }
}

impl IndexMut<[usize; 3]> for Points<MyFloat> {
...
impl Add<&Points<MyFloat>> for Points<MyFloat> {
    type Output = Self;
...
impl Add<Points<MyFloat>> for &Points<MyFloat> {
    type Output = Points<MyFloat>;

    fn add(self, other: Points<MyFloat>) -> Points<MyFloat> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for addition: {:?} vs {:?}",
                self.shape(),
...
impl Add<f64> for Points<MyFloat> {
    type Output = Self;
...
impl Add<f64> for &Points<MyFloat> {
    ...
    fn add(self, scalar: f64) -> Points<MyFloat> {
        Points(self.0.map(|x| x + scalar))
    }
}

impl Add<MyFloat> for Points<MyFloat> {
    type Output = Self;
...
impl Add<MyFloat> for &Points<MyFloat> {
    ...
    fn add(self, scalar: MyFloat) -> Points<MyFloat> {
        Points(self.0.map(|x| x + &scalar))
    }
}
...
impl Sub<&Points<MyFloat>> for Points<MyFloat> {
    type Output = Self;
...
impl Sub<Points<MyFloat>> for &Points<MyFloat> {
    ...
    fn sub(self, other: Points<MyFloat>) -> Points<MyFloat> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for subtraction: {:?} vs {:?}",
                self.shape(),
...
// Scalar subtraction
impl Sub<f64> for Points<MyFloat> {
    type Output = Self;
...
impl Sub<f64> for &Points<MyFloat> {
    ...
    fn sub(self, scalar: f64) -> Points<MyFloat> {
        Points(self.0.map(|x| x - scalar))
    }
}

impl Sub<MyFloat> for Points<MyFloat> {
    type Output = Self;
...
impl Sub<MyFloat> for &Points<MyFloat> {
    ...
    fn sub(self, scalar: MyFloat) -> Points<MyFloat> {
        Points(self.0.map(|x| x - &scalar))
    }
}
...
impl Mul<&Points<MyFloat>> for Points<MyFloat> {
    type Output = Self;
...
impl Mul<Points<MyFloat>> for &Points<MyFloat> {
    ...
    fn mul(self, other: Points<MyFloat>) -> Points<MyFloat> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise multiplication: {:?} vs {:?}",
                self.shape(),
...
impl Mul<f64> for Points<MyFloat> {
    type Output = Self;
...
impl Mul<f64> for &Points<MyFloat> {
    ...
    fn mul(self, scalar: f64) -> Points<MyFloat> {
        Points(self.0.map(|x| x * scalar))
    }
}

impl Mul<MyFloat> for Points<MyFloat> {
    type Output = Self;
...
impl Mul<MyFloat> for &Points<MyFloat> {
    ...
    fn mul(self, scalar: MyFloat) -> Points<MyFloat> {
        Points(self.0.map(|x| x * &scalar))
    }
}
...
impl Div<&Points<MyFloat>> for Points<MyFloat> {
    type Output = Self;
...
impl Div<Points<MyFloat>> for &Points<MyFloat> {
    ...
    fn div(self, other: Points<MyFloat>) -> Points<MyFloat> {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise division: {:?} vs {:?}",
                self.shape(),
...
// Scalar division
impl Div<f64> for Points<MyFloat> {
    type Output = Self;
...
impl Div<f64> for &Points<MyFloat> {
    ...
    fn div(self, scalar: f64) -> Points<MyFloat> {
        Points(self.0.map(|x| x / scalar))
    }
}

impl Div<MyFloat> for Points<MyFloat> {
    type Output = Self;
...
impl Div<MyFloat> for &Points<MyFloat> {
    ...
    fn div(self, scalar: MyFloat) -> Points<MyFloat> {
        Points(self.0.map(|x| x / &scalar))
    }
}
...
impl Neg for &Points<MyFloat> {
    ...
    fn neg(self) -> Points<MyFloat> {
        Points(-&self.0)
    }
}

// Assignment operators
impl AddAssign for Points<MyFloat> {
...
impl AddAssign<&Points<MyFloat>> for Points<MyFloat> {
    fn add_assign(&mut self, other: &Points<MyFloat>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for addition: {:?} vs {:?}",
                self.shape(),
...
impl SubAssign for Points<MyFloat> {
...
impl SubAssign<&Points<MyFloat>> for Points<MyFloat> {
    fn sub_assign(&mut self, other: &Points<MyFloat>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for subtraction: {:?} vs {:?}",
                self.shape(),
...
impl MulAssign for Points<MyFloat> {
...
impl MulAssign<&Points<MyFloat>> for Points<MyFloat> {
    fn mul_assign(&mut self, other: &Points<MyFloat>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise multiplication: {:?} vs {:?}",
                self.shape(),
...
impl DivAssign for Points<MyFloat> {
...
impl DivAssign<&Points<MyFloat>> for Points<MyFloat> {
    fn div_assign(&mut self, other: &Points<MyFloat>) {
        if self.shape() != other.shape() {
            panic!(
                "Points dimensions must match for element-wise division: {:?} vs {:?}",
                self.shape(),
...
impl AddAssign<f64> for Points<MyFloat> {
    fn add_assign(&mut self, scalar: f64) {
        self.0.map_inplace(|x| *x = &*x + scalar);
    }
}

impl AddAssign<MyFloat> for Points<MyFloat> {
    fn add_assign(&mut self, scalar: MyFloat) {
        self.0.map_inplace(|x| *x = &*x + &scalar);
    }
}

impl SubAssign<f64> for Points<MyFloat> {
    fn sub_assign(&mut self, scalar: f64) {
        self.0.map_inplace(|x| *x = &*x - scalar);
    }
}

impl SubAssign<MyFloat> for Points<MyFloat> {
    fn sub_assign(&mut self, scalar: MyFloat) {
        self.0.map_inplace(|x| *x = &*x - &scalar);
    }
}

impl MulAssign<f64> for Points<MyFloat> {
    fn mul_assign(&mut self, scalar: f64) {
        self.0.map_inplace(|x| *x = &*x * scalar);
    }
}

impl MulAssign<MyFloat> for Points<MyFloat> {
    fn mul_assign(&mut self, scalar: MyFloat) {
        self.0.map_inplace(|x| *x = &*x * &scalar);
    }
}

impl DivAssign<f64> for Points<MyFloat> {
    fn div_assign(&mut self, scalar: f64) {
        self.0.map_inplace(|x| *x = &*x / scalar);
    }
}

impl DivAssign<MyFloat> for Points<MyFloat> {
...
// Traits
impl Clone for Points<MyFloat> {
    fn clone(&self) -> Self {
        Points(self.0.clone())
    }
}

impl Default for Points<MyFloat> {
    fn default() -> Self {
        Points::zeros((0, 0, 0))
    }
}

impl PartialEq for Points<MyFloat> {
...
impl fmt::Display for Points<MyFloat> {
...
impl fmt::Debug for Points<MyFloat> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "Points({}x{}x{}) {}",
...
// Conversion traits
impl From<Array3<MyFloat>> for Points<MyFloat> {
    fn from(array: Array3<MyFloat>) -> Self {
        Points(array)
    }
}

impl From<ArrayView3<'_, MyFloat>> for Points<MyFloat> {
    fn from(array: ArrayView3<MyFloat>) -> Self {
        Points(array.to_owned())
    }
}

impl From<Points<MyFloat>> for Array3<MyFloat> {
    fn from(matrix: Points<MyFloat>) -> Self {
        matrix.0
    }
}

impl From<Points<f64>> for Points<MyFloat> {
    fn from(array: Points<f64>) -> Self {
...
mod points_myfloat_tests {
    ...
    fn test_from_vec() {
        ...
        let matrix = Points::<MyFloat>::from_vec(data).unwrap();
    ...
    fn test_from_vec_f64() {
        ...
        let matrix = Points::<MyFloat>::from_vec_f64(data).unwrap();
    ...
    fn test_from_vec_float() {
        ...
        let matrix = Points::<MyFloat>::from_vec_float(data).unwrap();
    ...
    fn test_from_vec_c64() {
        ...
        let matrix = Points::<MyFloat>::from_vec_c64(data).unwrap();
    ...
    fn test_from_vec_complex() {
        ...
        let matrix = Points::<MyFloat>::from_vec_complex(data).unwrap();
    ...
    #[test]
    fn test_arithmetic() {
        let a = Points::<MyFloat>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let b = Points::<MyFloat>::from_vec_f64(vec![
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
    ...
    fn test_scalar_operations() {
        let matrix = Points::<MyFloat>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();
    ...
    fn test_assignment_operators() {
        let mut matrix = Points::<MyFloat>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let other = Points::<MyFloat>::from_vec_f64(vec![
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
            vec![vec![9.0, 10.0], vec![11.0, 12.0]],
        ])
        .unwrap();
    ...
    #[test]
    fn test_equality() {
        let matrix1 = Points::<MyFloat>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let matrix2 = Points::<MyFloat>::from_vec_f64(vec![
            vec![vec![1.0, 2.0], vec![3.0, 4.0]],
            vec![vec![5.0, 6.0], vec![7.0, 8.0]],
        ])
        .unwrap();

        let matrix3 = Points::<MyFloat>::from_vec_f64(vec![
    ...
    fn test_error_cases() {
        ...
        let matrix1 = Points::<MyFloat>::zeros((2, 4, 5));
        let matrix2 = Points::<MyFloat>::zeros((3, 2, 1));
    ...
    fn test_conversions() {
        ...
        let matrix: Points<MyFloat> = data.into();
        assert_eq!(matrix[(0, 0, 0)], 1.0);
        assert_eq!(matrix[(1, 1, 1)], 8.0);
