...
impl Pts<MyFloat, Ix3> for Points<MyFloat, Ix3> {
    ...
    fn pt<I>(&self, index: usize) -> ndarray::ArrayView<'_, MyFloat, I::OutDim>
    where
    ...
    fn pt_mut<I>(&mut self, index: usize) -> ndarray::ArrayViewMut<'_, MyFloat, I::OutDim>
    where
        I: SliceArg<Ix3, OutDim = Dim<[usize; 2]>>,
    {
        if index >= self.npts() {
    ...
    fn set_pt(&mut self, index: usize, pt: Points<MyFloat, Ix2>) {
        if index >= self.npts() {
            panic!(
                "Point index {} out of bounds for matrix with {} points",
                index,
...
impl Matrix<MyFloat, Ix3> for Points<MyFloat, Ix3> {
...
impl Dot<Points<MyFloat, Ix2>> for Points<MyFloat, Ix3> {
    type Output = Points<MyFloat, Ix3>;
...
impl Dot<Points<MyFloat, Ix3>> for Points<MyFloat, Ix3> {
    type Output = Points<MyFloat, Ix3>;
...
impl Dot<Points<f64, Ix2>> for Points<MyFloat, Ix3> {
    type Output = Points<MyFloat, Ix3>;
...
impl Dot<Points<f64, Ix3>> for Points<MyFloat, Ix3> {
    type Output = Points<MyFloat, Ix3>;
...
impl From<&Points<MyFloat, Ix3>> for Points<MyFloat, Ix3> {
