...
impl Points<Complex64, Ix3> {
    ...
    pub fn from_vec(data: Vec<Vec<Vec<Complex64>>>) -> Result<Self, &'static str> {
        if data.is_empty() {
    ...
    pub fn from_vec_f64(data: Vec<Vec<Vec<f64>>>) -> Result<Self, &'static str> {
        if data.is_empty() {
            return Err("Cannot create matrix from empty data");
        }
    ...
    pub fn from_vec_float(data: Vec<Vec<Vec<f64>>>) -> Result<Self, &'static str> {
        Self::from_vec_f64(data)
    }

    /// Create a matrix from a 3D vector of complex tuples (real, imag)
    pub fn from_vec_c64(data: Vec<Vec<Vec<(f64, f64)>>>) -> Result<Self, &'static str> {
        if data.is_empty() {
            return Err("Cannot create matrix from empty data");
        }
    ...
    /// Create a matrix from a 3D vector of complex tuples (real, imag)
    pub fn from_vec_complex(data: Vec<Vec<Vec<(f64, f64)>>>) -> Result<Self, &'static str> {
...
impl Pts<Complex64, Ix3> for Points<Complex64, Ix3> {
    ...
    fn set_pt(&mut self, index: usize, pt: Points<Complex64, Ix2>) {
        if index >= self.npts() {
            panic!(
                "Point index {} out of bounds for matrix with {} points",
                index,
    ...
    fn fill(shape: impl IntoDimension<Dim = Dim<[usize; 3]>>, value: Complex64) -> Self {
    ...
    fn approx_eq(a: &ArrayView3<Complex64>, b: &ArrayView3<Complex64>, tol: f64) -> bool {
        ...
        for i in 0..npts {
            for j in 0..rows {
                for k in 0..cols {
                    let diff: Complex64 = &a[[i, j, k]] - &b[[i, j, k]];
                    if diff.norm() > tol {
                        return false;
                    }
                }
...
impl Matrix<Complex64, Ix3> for Points<Complex64, Ix3> {
    ...
    fn trace(&self) -> Result<Array1<Complex64>, LinalgError> {
    ...
    fn det(&self) -> Result<Array1<Complex64>, LinalgError> {
        _ = match self.is_square() {
            true => Ok(self.nrows()),
            false => Err(LinalgError::NotSquare {
                rows: self.nrows() as i32,
...
impl Dot<Points<Complex64, Ix2>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
    ...
    fn dot(&self, rhs: &Points<Complex64, Ix2>) -> Self::Output {
        ...
        for i in 0..self.npts() {
            let a: Points<Complex64, Ix2> = self
...
impl Dot<Points<Complex64, Ix3>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
...
impl Dot<Points<MyComplex, Ix2>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
...
impl Dot<Points<MyComplex, Ix3>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
...
impl Dot<Points<f64, Ix2>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
...
impl Dot<Points<f64, Ix3>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
...
impl Dot<Points<MyFloat, Ix2>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
...
impl Dot<Points<MyFloat, Ix3>> for Points<Complex64, Ix3> {
    type Output = Points<Complex64, Ix3>;
...
impl One for Points<Complex64, Ix3> {
    fn one() -> Self {
        Points::<Complex64, Ix3>::ones((0, 0, 0))
    }
...
impl From<Array3<MyComplex>> for Points<Complex64, Ix3> {
    fn from(array: Array3<MyComplex>) -> Self {
        Points(array).into()
    }
}

impl From<Array3<f64>> for Points<Complex64, Ix3> {
    fn from(array: Array3<f64>) -> Self {
        Points(array).into()
    }
}

impl From<Array3<MyFloat>> for Points<Complex64, Ix3> {
...
impl From<ArrayView3<'_, MyComplex>> for Points<Complex64, Ix3> {
    fn from(array: ArrayView3<MyComplex>) -> Self {
        Points(array.to_owned()).into()
    }
}

impl From<ArrayView3<'_, f64>> for Points<Complex64, Ix3> {
    fn from(array: ArrayView3<f64>) -> Self {
        Points(array.to_owned()).into()
    }
}

impl From<ArrayView3<'_, MyFloat>> for Points<Complex64, Ix3> {
...
impl From<Vec<Vec<Vec<Complex64>>>> for Points<Complex64, Ix3> {
    fn from(data: Vec<Vec<Vec<Complex64>>>) -> Self {
        Points::<Complex64, Ix3>::from_vec(data).expect("Invalid matrix data")
    }
}

impl From<Vec<Vec<Vec<f64>>>> for Points<Complex64, Ix3> {
    fn from(data: Vec<Vec<Vec<f64>>>) -> Self {
        Points::<Complex64, Ix3>::from_vec_f64(data).expect("Invalid matrix data")
    }
}

impl From<Vec<Vec<Vec<(f64, f64)>>>> for Points<Complex64, Ix3> {
    fn from(data: Vec<Vec<Vec<(f64, f64)>>>) -> Self {
        Points::<Complex64, Ix3>::from_vec_complex(data).expect("Invalid matrix data")
    }
}

impl From<&Points<Complex64, Ix3>> for Points<Complex64, Ix3> {
    fn from(point: &Points<Complex64, Ix3>) -> Self {
        point.clone()
    }
}

impl From<Points<MyComplex, Ix3>> for Points<Complex64, Ix3> {
    fn from(point: Points<MyComplex, Ix3>) -> Self {
...
impl From<Points<f64, Ix3>> for Points<Complex64, Ix3> {
...
impl From<Points<MyFloat, Ix3>> for Points<Complex64, Ix3> {
