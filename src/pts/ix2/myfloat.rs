...
impl Pts<MyFloat, Ix2> for Points<MyFloat, Ix2> {
    ...
    fn set_pt(&mut self, index: usize, pt: Points<MyFloat, Ix1>) {
        if index >= self.nrows() {
            panic!(
                "Row index {} out of bounds for matrix with {} points",
                index,
...
impl Matrix<MyFloat, Ix2> for Points<MyFloat, Ix2> {
...
impl Dot<Points<MyFloat, Ix2>> for Points<MyFloat, Ix2> {
    type Output = Points<MyFloat, Ix2>;
...
impl Dot<Points<MyFloat, Ix1>> for Points<MyFloat, Ix2> {
...
impl Dot<Points<f64, Ix2>> for Points<MyFloat, Ix2> {
    type Output = Points<MyFloat, Ix2>;
...
impl Dot<Points<f64, Ix1>> for Points<MyFloat, Ix2> {
    type Output = Points<MyFloat, Ix1>;
...
impl One for Points<MyFloat, Ix2> {
    fn one() -> Self {
        Points::<MyFloat, Ix2>::ones((0, 0))
    }
...
impl From<Array2<f64>> for Points<MyFloat, Ix2> {
...
impl From<ArrayView2<'_, f64>> for Points<MyFloat, Ix2> {
...
impl From<&Points<MyFloat, Ix2>> for Points<MyFloat, Ix2> {
...
mod points_ix2_myfloat_tests {
    ...
    fn test_conjugate_transpose() {
        let matrix =
            Points::<MyFloat, Ix2>::from_vec_f64(vec![vec![1.0, 3.0], vec![5.0, 7.0]]).unwrap();
