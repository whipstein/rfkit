use crate::{
    ...
    pts::{Matrix, MatrixComplex, Points, Points1, Points2, Points3, Pts, PtsComplex},
    scale::Scale,
    unit::{ArrayUnitValue, Unit, UnitValue},
};
    ...
    U: UnitValue + Frequency<U>,
{
    ...
    pub(super) z0: Vec<T>,
    pub(super) a: Option<Points3<T>>,
    pub(super) g: Option<Points3<T>>,
    pub(super) h: Option<Points3<T>>,
    pub(super) s: Option<Points3<T>>,
    pub(super) s_power: Option<Points3<T>>,
    pub(super) s_pseudo: Option<Points3<T>>,
    pub(super) s_traveling: Option<Points3<T>>,
    pub(super) y: Option<Points3<T>>,
    pub(super) t: Option<Points3<T>>,
    pub(super) z: Option<Points3<T>>,
}

impl<T, U> Network<T, U>
where
    T: ComplexScalar + 'static,
    <T as ComplexFloat>::Real: RealScalar + MathConst,
    U: UnitValue<Value = Array1<T::Real>> + Frequency<U>,
{
    pub fn new(
        freq: &U,
        z0: &Vec<T>,
    ...
    pub fn a_db(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::A, self.nports));
        }
    ...
    pub fn a_deg(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::A, self.nports));
        }
    ...
    pub fn a_im(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::A, self.nports));
        }
    ...
    pub fn a_mag(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::A, self.nports));
        }
    ...
    pub fn a_rad(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::A, self.nports));
        }
    ...
    pub fn a_re(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::A, self.nports));
        }
    ...
    pub fn chop_in_half(&self) -> Result<Network<T, U>, String> {
        ...
        for (i, mut pt) in out.axis_iter_mut(Axis(0)).enumerate() {
            ...
            let b21 = val[[1, 0]];
            let b22 = val[[1, 1]];
            let a11 = b11 / (T::C1 + b12);
            tmp.push(b21 * (T::C1 - b11 * b22 / (T::C1 + b12).powi(2)));
            let a22 = b22 / (T::C1 + b12);
            pt.assign(&array![[a11, T::C0], [T::C0, a22]].view());
        }

        let tmp_array = sqrt_phase_unwrap(Array1::<T>::from_vec(tmp));
    ...
    pub fn g_db(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::G, self.nports));
        }
    ...
    pub fn g_deg(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::G, self.nports));
        }
    ...
    pub fn g_im(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::G, self.nports));
        }
    ...
    pub fn g_mag(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::G, self.nports));
        }
    ...
    pub fn g_rad(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::G, self.nports));
        }
    ...
    pub fn g_re(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::G, self.nports));
        }
    ...
    pub fn gd(&self, port: PortVal, scale: Scale) -> Result<Points1<T::Real>, String> {
        let mut out: Vec<T::Real> = vec![];
        ...
        Ok(Points1::<T::Real>::from_vec(out))
    }

    pub fn h(&self) -> &Points3<T> {
        if self.nports != 2 {
    ...
    pub fn h_db(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::H, self.nports));
        }
    ...
    pub fn h_deg(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::H, self.nports));
        }
    ...
    pub fn h_im(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::H, self.nports));
        }
    ...
    pub fn h_mag(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::H, self.nports));
        }
    ...
    pub fn h_rad(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::H, self.nports));
        }
    ...
    pub fn h_re(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::H, self.nports));
        }
    ...
    pub fn is_reciprocal(&self) -> bool {
        for pt in self.s().outer_iter() {
            if !Points::<T, Ix2>::new(pt.to_owned()).is_reciprocal() {
                return false;
            }
        }
        true
    ...
    pub fn k(&self) -> Result<PortPoints<T::Real>, String> {
        if self.nports != 2 {
            return Err(format!(
        ...
        let mut val = Array1::<T::Real>::zeros(s11.len());
        azip!((index i, &s11 in &s11, &s12 in &s12, &s21 in &s21, &s22 in &s22, &d in &d) {
            val[i] = (T::Real::C1 - s11.abs().powi(2) - s22.abs().powi(2) + d.abs().powi(2)) / (T::Real::C2 * (s21 * s12).abs());
        });

        Ok(Points(val))
    }

    pub fn max_gain(&self) -> Result<PortPoints<T::Real>, String> {
        if self.nports != 2 {
            return Err(format!(
        ...
        Ok(&max_stable_gain
            / (&k
                + Points1::<T::Real>::from_shape_fn(k.len(), |i| {
                    (k[i].powi(2) - T::Real::C1).sqrt()
                })))
    }

    pub fn max_stable_gain(&self) -> Result<PortPoints<T::Real>, String> {
        if self.nports != 2 {
            return Err(format!(
    ...
    pub fn mu(&self) -> Result<PortPoints<T::Real>, String> {
        if self.nports != 2 {
            return Err(format!(
        ...
        let d_abs = Array1::<T::Real>::from_shape_fn(self.npts, |i| d[i].abs());
        let denom_arg1 = &self.s().slice(s![.., 1, 1]) - &self.s_conj().slice(s![.., 0, 0]) * &d;
        let denom_arg2 = &self.s().slice(s![.., 0, 1]) * &self.s_conj().slice(s![.., 1, 0]);
        let denom = Array1::<T::Real>::from_shape_fn(self.npts, |i| {
            denom_arg1[i].abs() + denom_arg2[i].abs()
        });
        let num = &Array1::<T::Real>::ones(self.npts)
            - &Array1::<T::Real>::from_shape_fn(self.npts, |i| {
    ...
    pub fn mu_prime(&self) -> Result<PortPoints<T::Real>, String> {
        if self.nports != 2 {
            return Err(format!(
    ...
    pub fn net(&self, param: RFParameter) -> &Points3<T> {
        match param {
            RFParameter::A => {
                if self.nports != 2 {
                    panic!(
    ...
    pub fn net_at_freq_idx(&self, param: RFParameter, idx: usize) -> Points2<T> {
        Points::<T, Ix2>::new(self.net(param).slice(s![idx, .., ..]).to_owned())
    }

    pub fn net_at_port(&self, param: RFParameter, port: PortVal) -> PortPoints<T> {
        Points(self.net(param).slice(s![.., port.0, port.1]).to_owned())
    }

    pub fn net_at_port_conj(&self, param: RFParameter, port: PortVal) -> PortPoints<T> {
        Points(
            self.net_conj(param)
    ...
    pub fn net_at_port_idx(&self, param: RFParameter, j: usize, k: usize) -> PortPoints<T> {
        Points(self.net(param).slice(s![.., j, k]).to_owned())
    }

    pub fn net_at_idx(&self, param: RFParameter, idx: usize, j: usize, k: usize) -> T {
        self.net_at_freq_idx(param, idx)[[j, k]]
    }

    pub fn net_conj(&self, param: RFParameter) -> Points3<T> {
        Points::from_shape_fn(self.net(param).dim().into_dimension(), |(i, j, k)| {
            self.net(param)[[i, j, k]].conj()
        })
    }

    pub fn net_db(&self, param: RFParameter) -> Points3<T::Real> {
        self.net(param).db()
    }

    pub fn net_deg(&self, param: RFParameter) -> Points3<T::Real> {
        self.net(param).deg()
    }

    pub fn net_im(&self, param: RFParameter) -> Points3<T::Real> {
        self.net(param).im()
    }

    pub fn net_mag(&self, param: RFParameter) -> Points3<T::Real> {
        self.net(param).mag()
    }

    pub fn net_rad(&self, param: RFParameter) -> Points3<T::Real> {
        self.net(param).rad()
    }

    pub fn net_rad_at_port(&self, param: RFParameter, port: PortVal) -> PortPoints<T::Real> {
        Points(
            self.net(param)
                .rad()
                .slice(s![.., port.0, port.1])
    ...
    pub fn net_re(&self, param: RFParameter) -> Points3<T::Real> {
        self.net(param).re()
    }
    ...
    pub fn passivity(&self) -> Array1<T::Real> {
        if self.nports < 2 {
            panic!(
                "{}",
                format!(
        ...
        for (_i, pt) in self.s().outer_iter().enumerate() {
            let mut acc: Array2<T> = pt.map(|x| x.conj()).t().to_owned();
            acc = acc.dot(&pt);

            let mat = Array2::<T>::eye(acc.nrows()) - acc;
    ...
    pub fn reciprocity(&self) -> Points3<T::Real> {
        self.s().reciprocity().unwrap()
    }

    pub fn s(&self) -> &Points3<T> {
        self.s.as_ref().unwrap()
    }

    pub fn s_power(&self) -> &Points3<T> {
        self.s_power.as_ref().unwrap()
    }

    pub fn s_pseudo(&self) -> &Points3<T> {
        self.s_pseudo.as_ref().unwrap()
    }

    pub fn s_traveling(&self) -> &Points3<T> {
        self.s_traveling.as_ref().unwrap()
    }

    pub fn s_conj(&self) -> Points3<T> {
        self.s.as_ref().unwrap().conj()
    }

    pub fn s_db(&self) -> Points3<T::Real> {
        self.net_db(RFParameter::S)
    }

    pub fn s_deg(&self) -> Points3<T::Real> {
        self.net_deg(RFParameter::S)
    }

    pub fn s_im(&self) -> Points3<T::Real> {
        self.net_im(RFParameter::S)
    }

    pub fn s_mag(&self) -> Points3<T::Real> {
        self.net_mag(RFParameter::S)
    }

    pub fn s_rad(&self) -> Points3<T::Real> {
        self.net_rad(RFParameter::S)
    }

    pub fn s_re(&self) -> Points3<T::Real> {
        self.net_re(RFParameter::S)
    }

    pub fn set_net(&mut self, net: &Points3<T>, param: RFParameter) {
    ...
    pub fn t_db(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::T, self.nports));
        }
    ...
    pub fn t_deg(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::T, self.nports));
        }
    ...
    pub fn t_im(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::T, self.nports));
        }
    ...
    pub fn t_mag(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::T, self.nports));
        }
    ...
    pub fn t_rad(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::T, self.nports));
        }
    ...
    pub fn t_re(&self) -> Points3<T::Real> {
        if self.nports != 2 {
            panic!("{}", network_err_msg(RFParameter::T, self.nports));
        }
    ...
    pub fn y(&self) -> &Points3<T> {
        self.y.as_ref().unwrap()
    }

    pub fn y_db(&self) -> Points3<T::Real> {
        self.net_db(RFParameter::Y)
    }

    pub fn y_deg(&self) -> Points3<T::Real> {
        self.net_deg(RFParameter::Y)
    }

    pub fn y_im(&self) -> Points3<T::Real> {
        self.net_im(RFParameter::Y)
    }

    pub fn y_mag(&self) -> Points3<T::Real> {
        self.net_mag(RFParameter::Y)
    }

    pub fn y_rad(&self) -> Points3<T::Real> {
        self.net_rad(RFParameter::Y)
    }

    pub fn y_re(&self) -> Points3<T::Real> {
        self.net_re(RFParameter::Y)
    }

    pub fn z(&self) -> &Points3<T> {
        self.z.as_ref().unwrap()
    }

    pub fn z_db(&self) -> Points3<T::Real> {
        self.net_db(RFParameter::Z)
    }

    pub fn z_deg(&self) -> Points3<T::Real> {
        self.net_deg(RFParameter::Z)
    }

    pub fn z_im(&self) -> Points3<T::Real> {
        self.net_im(RFParameter::Z)
    }

    pub fn z_mag(&self) -> Points3<T::Real> {
        self.net_mag(RFParameter::Z)
    }

    pub fn z_rad(&self) -> Points3<T::Real> {
        self.net_rad(RFParameter::Z)
    }

    pub fn z_re(&self) -> Points3<T::Real> {
        self.net_re(RFParameter::Z)
    }

    pub fn z0(&self) -> &Vec<T> {
        &self.z0
    }

    pub fn z0_at_port_idx(&self, idx: usize) -> &T {
        &self.z0[idx]
    }

    pub fn z0_to_vector(&self) -> Vec<T> {
...
where
    T: ComplexScalar,
    <T as ComplexFloat>::Real: RealScalar,
    U: UnitValue + Frequency<U> + fmt::Debug,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
mod network_network_tests {
    ...
    use crate::{
        ...
        points,
        pts::{Matrix, Points1, Points2, Points3, Pts},
        scale::*,
        unit::*,
        util::*,
    };
