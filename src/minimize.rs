...
// fn dot_1d_1d<T>(a: &Points1<T>, b: &Points1<T>) -> T
// where
//     T: RFFloat,
//     for<'a, 'b> &'a T: std::ops::Mul<&'b T, Output = T>,
// {
...
// // Helper function for dot product
// fn dot_1d_2d<T>(a: &Points1<T>, b: ArrayView2<T>) -> Points1<T>
// where
//     T: RFFloat,
//     for<'a, 'b> &'a T: std::ops::Mul<&'b T, Output = T>,
// {
//     let mut result = Points1::<T>::zeros(b.ncols());
//     for j in 0..b.ncols() {
//         for i in 0..b.nrows() {
//             result[j] += &a[i] * &b[[i, j]];
//         }
...
// fn dot_2d_1d<T>(a: ArrayView2<T>, b: &Points1<T>) -> Points1<T>
// where
//     T: RFFloat,
//     for<'a, 'b> &'a T: std::ops::Mul<&'b T, Output = T>,
// {
//     let mut result = Points1::<T>::zeros(a.nrows());
//     for i in 0..a.nrows() {
//         for j in 0..a.ncols() {
//             result[i] += &a[[i, j]] * &b[j];
//         }
...
// // Helper function for dot product
// fn dot_2d_2d<T>(a: ArrayView2<T>, b: ArrayView2<T>) -> Points2<T>
// where
//     T: RFFloat,
//     for<'a, 'b> &'a T: std::ops::Mul<&'b T, Output = T>,
// {
//     let mut result = Points2::<T>::zeros((a.nrows(), b.ncols()));
//     for i in 0..a.nrows() {
//         for j in 0..b.ncols() {
//             for k in 0..a.ncols() {
...
// fn norm_1d_linf<T>(a: &Points1<T>) -> T
// where
//     T: RFFloat,
// {
//     let mut max = T::zero();
...
//     //         let a: Points1<MyFloat> = array![0.1.into(), 0.2.into(), 0.3.into()];
...
//     //         let a: Points1<MyFloat> = array![1.0.into(), 2.0.into(), 3.0.into()];
//     //         let b = array![
//     //             [1.0.into(), 2.0.into()],
//     //             [3.0.into(), 4.0.into()],
//     //             [5.0.into(), 6.0.into()]
...
//     //         let a: Points1<MyFloat> = array![1.0.into(), 2.0.into()];
...
//     //         let a: Points1<MyFloat> = array![0.0.into(), 0.0.into(), 0.0.into()];
//     //         let b = array![
//     //             [1.0.into(), 2.0.into()],
//     //             [3.0.into(), 4.0.into()],
//     //             [5.0.into(), 6.0.into()]
...
//     //         let a: Points2<MyFloat> = array![[1.0.into(), 2.0.into()], [3.0.into(), 4.0.into()]];
...
//     //         let a: Points2<MyFloat> = array![[0.0.into(), 0.0.into()], [0.0.into(), 0.0.into()]];
//     //         let b = array![5.0.into(), 6.0.into()];
//     //         let result = dot_2d_1d(a.view(), b.view());
...
//     //         let a: Points2<MyFloat> = array![[1.0.into(), 2.0.into(), 3.0.into()]];
//     //         let b = array![4.0.into(), 5.0.into(), 6.0.into()];
//     //         let result = dot_2d_1d(a.view(), b.view());
...
//     //         let a: Points2<MyFloat> = array![[2.0.into()], [3.0.into()], [4.0.into()]];
...
//     //         let a: Points2<MyFloat> = array![[0.5.into(), 0.25.into()], [0.75.into(), 0.125.into()]];
...
//     //         let a: Points2<MyFloat> = array![[5.0.into()]];
//     //         let b = array![3.0.into()];
//     //         let result = dot_2d_1d(a.view(), b.view());
...
//     //         // [0, -1]
//     //         // [1,  0]
//     //         let a: Points2<MyFloat> = array![[0.0.into(), (-1.0).into()], [1.0.into(), 0.0.into()]];
...
//     //         let a: Points2<MyFloat> = array![[1.0.into(), 2.0.into(), 3.0.into()]]; // Row vector (1x3)
...
//             // Test that ||c*v|| = |c| * ||v||
//             let a: Points1<MyFloat> = array![3.0.into(), 4.0.into()];
...
//             // ||a + b|| <= ||a|| + ||b||
//             let a: Points1<MyFloat> = array![1.0.into(), 2.0.into()];
//             let b: Points1<MyFloat> = array![3.0.into(), 4.0.into()];
//             let sum: Points1<MyFloat> = array![4.0.into(), 6.0.into()];
...
//             let vec_1d: Points1<MyFloat> = array![3.0.into(), 4.0.into()];
//             let vec_2d: Points2<MyFloat> = array![[3.0.into()], [4.0.into()]];
